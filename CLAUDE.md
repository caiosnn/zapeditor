...
- **Qualidade máxima:** `DOWNLOAD_MAX_HEIGHT=0` (default) → seletor `bv*+ba/b` (melhor vídeo + melhor áudio, sem teto). `>0` limita a altura. Teto de tamanho `DOWNLOAD_MAX_FILESIZE_MB=500`.
